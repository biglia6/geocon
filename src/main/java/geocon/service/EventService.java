...
public class EventService {
    ...
    private static final String EVENTS_TYPE_NAME = Configuration.EVENTS_TYPE_NAME;
    ...
    public String get(@QueryParam(QParams.ID) String id) {
        ...
        GetResponse response = esClient
                .prepareGet(PRIMARY_INDEX_NAME, EVENTS_TYPE_NAME, id).execute()
                .actionGet();
    ...
    public String update(@QueryParam(QParams.ID) String id,
            @PathParam("metadata") String metadata) {
    			...
    			esClient
    			.prepareIndex(PRIMARY_INDEX_NAME, EVENTS_TYPE_NAME, id)
